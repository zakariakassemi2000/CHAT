...
const API_KEY = "sk-proj-SPfwvX2K5TkqrerIQJUqT3BlbkFJQRtTGcN6NDb8WMErxsxB"; // Paste API key here
...
chatInput.addEventListener("keydown", (e) => {
  // If Enter key is pressed without the Shift key, handle the chat
